                    ...
                    <table data-toolbar="#toolbar" class="table" data-toggle="table">
                        ...
                        foreach ($invoice as $order){
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    <a onclick="alert('Bạn đã duyệt thành công đơn hàng')" href="index.php?controller=order&action=edit&id=<?= $order['id']?>&ors=<?= $order['status']?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
